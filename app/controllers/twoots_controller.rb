class TwootsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @twoot.save
        format.html { redirect_to twoot_url(@twoot), notice: "Twoot was successfully created." }
  ...
  def update
    respond_to do |format|
      if @twoot.update(twoot_params)
        format.html { redirect_to twoot_url(@twoot), notice: "Twoot was successfully updated." }
